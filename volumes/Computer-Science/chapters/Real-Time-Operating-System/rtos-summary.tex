...
Jitter refers to the unpredictable variation in the timing of a periodic event—specifically, the deviation from the expected or ideal timing of when a task is executed.
...
\end{align*}
where $mathpzc{w}$, $C$ is WCET, $mathpzc{J}$ is jitter,  in a given time unit.
