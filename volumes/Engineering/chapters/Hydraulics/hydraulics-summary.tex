...
\begin{tikzpicture}
  %\pic (myvalve1) at (0,0) {dcv={actuator=lever}};
  \pic (myvalve1) at (4,0) {dcv={actuator=solenoid}};
  %\pic (myvalve1) at (0,0) {dcv};
\end{tikzpicture}
%    dcv={
%      width=2.5,
%      height=1.5,
%      port spacing=0.4,
%      stage spacing=0.4,
%      stages={{spool type=spool open center},{spool type=spool closed center},{spool type=spool tandem center}}
%    }
%  };
%
