...
\tikzstyle{every node}=[font=\LARGE]
	\draw [short] (3.75,25) -- (3.75,16);
	\draw [short] (4.75,25) -- (4.75,16);
	\draw [short] (11.5,25.25) -- (11.5,16);
	\draw [short] (12.5,25.25) -- (12.5,16);
	\draw [short] (11.5,16) .. controls (10.5,12.5) and (6,12.5) .. (4.75,16);
	\draw [short] (3.75,16) .. controls (5.25,11.25) and (11,11.25) .. (12.5,16);
	\draw [short] (3.75,18) -- (4.75,18);
	\draw [short] (11.5,19.75) -- (12.5,19.75);
	\draw [short] (11.5,22.25) -- (12.5,22.25);
	\draw [short] (3.75,25) .. controls (4,24.75) and (4.5,24.75) .. (4.75,25);
	\draw [short] (11.5,25.25) .. controls (11.75,25) and (12.25,25) .. (12.5,25.25);
	\draw [short] (11.5,25.25) .. controls (11.75,25.5) and (12.25,25.5) .. (12.5,25.25);
	\draw [short] (3.75,25) .. controls (4,25.25) and (4.5,25.25) .. (4.75,25);
	\draw [short, red] (4.25,18) .. controls (4.25,16) and (3.75,15.75) .. (5.75,13.75);
	\draw [short, red] (5.75,13.75) .. controls (8,12) and (10,13) .. (11.25,14.5);
	\draw [short, red] (11.25,14.5) .. controls (12,15.5) and (12.25,15.75) .. (12,17.5);
...
\draw [->, >=Stealth] (5.25,20) -- (5.25,18);
	\draw [short] (12,25.25) .. controls (12.5,25.75) and (12.5,25.5) .. (13,25.75) node[right] {$A$};
	\draw [short] (4,17.5) -- (4.5,17.75);
	\draw [short] (4,16.75) -- (4.5,17);
	\draw [short] (4,15.75) -- (4.5,16);
	\draw [short] (4.5,15) -- (4.75,15.25);
	\draw [short] (5.25,13.75) -- (5.75,14);
	\draw [short] (6.25,13.25) -- (6.75,13.5);
	\draw [short] (7.75,12.75) -- (8.25,13.25);
	\draw [short] (9.5,13) -- (10,13.75);
	\draw [short] (10.5,13.5) -- (11,14.5);
	\draw [short] (11.75,15.5) -- (12,15.75);
	\draw [short] (11.75,16.75) -- (12.25,17.25);
	\draw [short] (11.75,18) -- (12.25,18.25);
	\draw [short] (11.75,19) -- (12.25,19.25);
	\draw [short] (11.75,20) -- (12.25,20.25);
	\draw [short] (11.75,20.25) -- (12.25,20.5);
	\draw [short] (11.75,20.75) -- (12.25,21);
	\draw [short] (11.75,21) -- (12.25,21.25);
	\draw [short] (11.75,21.5) -- (12.25,21.75);
	\draw [short] (11.75,21.75) -- (12.25,22);
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
	\draw [short] (10,29) -- (10,20.75) node[midway, right] {$\ell$};
\draw [short] (9.5,29) -- (10.5,29);
\draw [short] (9.75,29) -- (10,29.25);
\draw [short] (10.25,29) -- (10.5,29.25);
\draw [short] (6.5,20.75) -- (13.5,20.75);
\draw [short] (6.5,20.75) -- (6.5,20.25);
\draw [short] (13.5,20.75) -- (13.5,20.25);
\draw [short] (6.5,20.25) -- (13.5,20.25);
\draw  (7.25,20) circle (0.5cm);
\draw  (12.75,20) circle (0.5cm);
\draw [short] (15.75,24) -- (24.25,24);
\draw [short] (15.75,24.75) -- (24.25,24.75);
\draw [short] (15.75,24) -- (15.75,24.75);
\draw [short] (24.25,24) -- (24.25,24.75);
	\fill  (19.75,24.4) circle (3pt) node[below=3mm] {$P$};
\fill  (10,20.5) circle (3pt) node[below=3mm] {$P$};
\draw [dashed] (16.25,21.75) -- (23.75,27.5);
	\draw [short] (21.25,25.5) .. controls (21.5,25.25) and (21.75,25) .. (21.75,24.75) node[midway, right] {$\theta$};
\end{tikzpicture}
}%
\end{figure}
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
	\draw [short] (3.5,26.75) -- (19.25,26.75);
	\draw [short] (3.5,26.75) -- (3.5,25);
	\draw [short] (3.5,25) -- (19.25,25);
	\draw [short] (19.25,25) -- (19.25,26.75);
	\draw [short] (3.5,25) -- (3.5,23.5);
	\draw [short] (3.5,23.5) -- (5.75,23.5);
	\draw [short] (5.75,23.5) -- (5.75,25);
	\draw [short] (19.25,25) -- (19.25,23.5);
	\draw [short] (19.25,23.5) -- (16.75,23.5);
	\draw [short] (16.75,23.5) -- (16.75,25);
	...
	\draw [short] (4.5,24.25) -- (2.5,23.25) node[left] {$0.2$};
	\draw [short] (18,24.25) -- (20.75,24) node[right] {$0.2$kg};;
\end{tikzpicture}
}%
\end{figure}
