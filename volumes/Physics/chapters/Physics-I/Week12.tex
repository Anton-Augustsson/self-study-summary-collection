...
\begin{tikzpicture}
	...
	\draw[very thick] (0.7,0) -- (0.7,1);

	\draw[very thick] (0,0) arc[start angle=110, end angle=430, radius=10mm];
  
  \draw (0,0.6) -- (0.7,0.6);
  \draw (0,0.4) -- (0.7,0.4);

	\draw[very thin] (-0.15,-0.6) -- (0.5,-0.2);
	\draw[very thin] (-0.35,-1.2) -- (0.8,-0.5);
	\draw[very thin] (-0.1,-1.5) -- (0.9,-0.9);

    \draw[->, thick, red] (0.2,1.5) -- (0.2,0.6) node[at start, left] {\large$\vec{F}$};
	\draw[->, thick] (1.3,1.4) arc[start angle=90, end angle=180, radius=8mm] node[at start, right] {\large$A$};
...
\begin{tikzpicture}
	...
	\draw[very thick] (1.5,2) -- (1.5,0.5);
	\draw[very thick] (1,0) -- (8,0);
	\draw[very thick] (1.5,0.5) -- (7.5,0.5);
	\draw[very thick] (7.5,0.5) -- (7.5,2);
	\draw[very thick] (8,0) -- (8,2);

	\draw[very thick] (8,2) -- (10,2);
	\draw[very thick] (7.5,2) -- (5.5,2);
	\draw[very thick] (5.5,2) -- (5.5,3);
	\draw[very thick] (10,2) -- (10,3);
	\draw (5.5,2.8) -- (10,2.8);
	\draw (5.5,2.7) -- (10,2.7);
	\node at (6.1,3) {$A_2$};

	\draw[->, thick, red] (1.25,3.5) -- (1.25,2.8) node[midway, right] {\large$F_1$};
	\draw[->, thick, red] (7.75,4.5) -- (7.75,2.8) node[midway, right] {\large$F_2$};

	\begin{scope}[shift={(0.35,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(0.8,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(1.35,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(1.8,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}

	\begin{scope}[shift={(1.28,1.85)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(1.28,1.35)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(1.28,0.85)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(1.28,0.35)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}

	\begin{scope}[shift={(2.0,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(2.5,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(3.0,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(3.5,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(4.0,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(4.5,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(5.0,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(5.5,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(6.0,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(6.5,0.25)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}

	\begin{scope}[shift={(7.72,1.85)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(7.72,1.35)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(7.72,0.85)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}
	\begin{scope}[shift={(7.72,0.35)}, rotate=45] \draw (-0.2,0) -- (0.2,0); \end{scope}

	\begin{scope}[shift={(6.35,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(6.8,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(7.35,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(7.8,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(8.35,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
	\begin{scope}[shift={(8.8,2.35)}, rotate=45] \draw (-0.25,0) -- (0.25,0); \end{scope}
...
\begin{tikzpicture}
	...
	\draw[Very thick] (0,0,0) -- ++(-\cubex,0,0) -- ++(0,-\cubey,0) -- ++(\cubex,0,0) -- cycle;
	\draw[Very thick] (0,0,0) -- ++(0,0,-\cubez) -- ++(0,-\cubey,0) -- ++(0,0,\cubez) -- cycle;
	\draw[Very thick] (0,0,0) -- ++(-\cubex,0,0) -- ++(0,0,-\cubez) -- ++(\cubex,0,0) -- cycle;

	\draw[->] (-6,-2,0) -- ++(0,2,0) node[left] {\Large$y$};

	\draw (0,0,-\cubez) -- ++(1,0,0) node[right] {\Large$y+\Delta y$} node[right=20mm] {\Large$P_{y+\Delta y}$};
	\draw (0,-\cubey,-\cubez) -- ++(1,0,0) node[right] {\Large$y$} node[right=8mm] {\Large$P_{y}$};
	\draw[->, red] (-\cubex/2,1,-\cubez/2) -- ++(0,-1,0) node[at start, right] {\Large$F_2$};
	\draw[->, red] (-\cubex/2-0.1,-0.1,-\cubez/2) -- ++(0,-2,0) node[right] {\Large$\Delta mg$};
	\draw[->, red] (-\cubex/2,-2,0) -- (-\cubex/2,-\cubey/2,0) node[midway, left] {\Large$F_1$};

	\draw (-\cubex,0,-\cubez/2) -- (-\cubex-0.2,0.4,-\cubez/2) node[left] {\Large$A$};
	\draw (-\cubex,0,-\cubez) -- (-\cubex-0.2,0.8,-\cubez) node[above] {\Large$\Delta m=A\Delta y\rho_y$};
	\node at (-3.5,-0.5,0) {$\rho_y$};
...
\tikzstyle{every node}=[font=\LARGE]
	\draw[->, >=Stealth] (4.75,28) -- (4.75,33) node[midway, right] {$y$};
	\draw[<->, >=Stealth, dashed] (8,28.5) -- (8,33.5) node[midway, right] {$h$};
	\draw[dashed] (8,28.5) -- (9.75,28.5) node[at start, left] {$y_1$};
	\draw[short] (11.75,31) -- (12.75,35);
	\draw[short] (11.75,31) -- (9.75,31);
	\draw[short] (9.75,31) -- (9.75,28.5);
	\draw[short] (9.75,28.5) -- (22.25,28.5);
	\draw[short] (15.5,31) -- (17.75,31);
	\draw[short] (15.5,31) -- (14.5,35);
	\draw[short] (17.75,31) -- (21.25,35.25);
	\draw[short] (19.75,31) -- (22.5,34.75);
	\draw[short] (19.75,31) -- (22.25,31);
	\draw[short] (22.25,31) -- (22.25,28.5);
	\draw[short] (22.25,34.25) -- (20.5,34.25);
	\draw[short] (14.75,34.25) -- (12.5,34.25);
	\draw[dashed] (20.5,34.25) -- (11.5,34.25) node[left] {$y_2$};
	\draw[short] (13.25,34.25) -- (13.25,28.5);
	\draw[short] (13.75,34.25) -- (13.75,28.5);
	\draw[short] (13.25,28.5) .. controls (13.25,28.75) and (13.75,28.75) .. (13.75,28.5);

	\fill (10.7,28.6) circle (3pt);
	\fill (12.3,28.6) circle (3pt) node[above=2mm] {$\rho$};
	\fill (16.0,28.6) circle (3pt) node[above=2mm] {$P_1$};
	\fill (20.3,28.6) circle (3pt);

	\draw (13.5,34.2) circle (6pt);
	\draw (13.5,34.2) -- ++(1,2) node[above] {$A$};
	\node at (21, 36) {Weight $=$ $Ah\rho g$.};
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
	\draw[line width=1pt, short] (7.5,26.5) -- (7.5,20.5);
	\draw[line width=1pt, short] (7.5,20.5) -- (14,20.5);
	\draw[line width=1pt, short] (14,20.5) -- (14,26.75);
	\draw[short] (7.5,25.5) -- (10,25.5);
	\draw[short] (14,25.5) -- (11.25,25.5);
	\draw[line width=1pt, short] (10,24.25) -- (10,33);
	\draw[line width=1pt, short] (11.25,24.25) -- (11.25,33);
	\draw[line width=1pt, short] (10,33) .. controls (10.25,34) and (11,34) .. (11.25,33);
	\draw[short] (10.75,33.25) -- (12.75,34.5) node[right] {$MT$};;
	\draw[short] (10.5,32.75) .. controls (10.25,33.75) and (10,33.75) .. (8.5,34) node[left] {$P_2=0$};
	\draw[short] (10,32.75) -- (11.25,32.75);
	\draw[dashed] (11.25,32.75) -- (13.75,32.75) node[right] {$y_2$};
	\fill (12.5,25.5) circle (4pt) node[above=2mm] {$P_1$};
	\draw[dashed] (14,25.5) -- (15.5,25.5) node[right] {$y_1$};
	\draw[short] (10.25,31.75) -- (11,32.25);
	\draw[short] (10.25,30.75) -- (11,31.25);
	\draw[short] (10.25,29.75) -- (11,30.25);
	\draw[short] (10.25,28.75) -- (11,29.25);
	\draw[short] (10.25,27.5) -- (11,28);
	\draw[short] (10.25,26.5) -- (11,27);
	\draw[short] (10.25,25.75) -- (11,26.25);
	\draw[short] (10.25,24.75) -- (11,25.25);
	\draw[short] (7.75,24.75) -- (8.5,25.25);
	\draw[short] (8.25,23.75) -- (9.5,24.75);
	\draw[short] (8.5,22.5) -- (9.75,23.75);
	\draw[short] (8.75,21.25) -- (12,24.5);
	\draw[short] (10.75,21.25) -- (13.5,24.25);
	\draw[short] (12.25,21.5) -- (13.25,22.75);
\end{tikzpicture}
}%
\label{fig:my_label}
\end{figure}
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
	\draw[short] (6.5,31.75) -- (6.5,31.75);
	\draw[short] (6,31.5) -- (7.75,31.5);
	\draw[short] (7.75,31.5) .. controls (8.75,31.25) and (8.5,31) .. (8.75,30.5);
	\draw[short] (8.75,30.5) -- (8.75,24.25);
	\draw[short] (8.75,24.25) .. controls (8.75,23.75) and (9,23.75) .. (9.25,23.75);
	\draw[short] (9.25,23.75) -- (12,23.75);
	\draw[short] (12,23.75) .. controls (12.25,23.75) and (12.5,23.75) .. (12.5,24.25);
	\draw[short] (12.5,24.25) -- (12.5,32.5);
	\draw[short] (6,30.75) -- (7.75,30.75);
	\draw[short] (7.75,30.75) .. controls (8,30.75) and (8,30.5) .. (8,30.5);
	\draw[short] (8,30.5) -- (8,24.25);
	\draw[short] (8,24.25) .. controls (8.25,23.25) and (8.25,23.25) .. (9.25,23);
	\draw[short] (9.25,23) -- (12,23);
	\draw[short] (12,23) .. controls (12.75,23) and (13.25,23.5) .. (13.25,24.25);
	\draw[short] (13.25,24.25) -- (13.25,32.5) node[above] {open};
	\draw[->, >=Stealth, red] (5.5,31.25) -- (6.5,31.25);
	\draw [short] (6,31.25) .. controls (5.5,31.25) and (5.5,31.25) .. (5.25,32) node[above] {open};
	\draw[short] (8,27.5) -- (8.75,27.5);
	\draw[short] (12.5,27.5) -- (13.25,27.5);
	\draw[short, red] (12.5,29) -- (13.25,29);
	\draw[short, red] (8,26.25) -- (8.75,26.25);
	\draw[short] (8.25,25.25) -- (7,25) node[left] {$\rho$};
	\draw[dashed] (8.75,26.25) -- (14.75,26.25);
	\draw[dashed] (13.25,29) -- (14.5,29);
	\draw[<->, >=Stealth, red] (14,29) -- (14,26.25) node[midway, right] {$h$};
	\draw[short] (8.25,27) -- (8.5,27.25);
	\draw[short] (8.25,26.5) -- (8.5,26.75);
	\draw[short] (8.25,25.75) -- (8.5,26);
	\draw[short] (8.25,25) -- (8.5,25.25);
	\draw[short] (8.25,24.25) -- (8.5,24.5);
	\draw[short] (8.5,23.75) -- (8.75,24);
	\draw[short] (9,23.25) -- (9.25,23.5);
	\draw[short] (9.75,23.25) -- (10,23.5);
	\draw[short] (10.5,23.25) -- (10.75,23.5);
	\draw[short] (11.25,23.25) -- (11.5,23.5);
	\draw[short] (12,23.25) -- (12.25,23.5);
	\draw[short] (12.75,24) -- (13,24.25);
	\draw[short] (12.75,24.75) -- (13,25);
	\draw[short] (12.5,23.5) -- (12.75,23.75);
	\draw[short] (12.75,25.5) -- (13,25.75);
	\draw[short] (12.75,26.5) -- (13,26.75);
	\draw[short] (12.75,27) -- (13,27.25);
\end{tikzpicture}
}%
\end{figure}
...
\resizebox{0.4\textwidth}{!}{%
\begin{tikzpicture}
	\node (A) [cylinder, shape border rotate=90, draw,minimum height=3cm,minimum width=1cm] { };
	\draw (-2,0.8) -- (-0.5,0.8);
	\draw (0.5,0.8) -- (2,0.8) node[right] {$y_2$};
	\draw[dashed] (0.5,-1.2) -- (2,-1.2) node[right] {$y_1$};
	\draw (-0.5,0.8) arc[start angle=240, end angle=300, radius=10mm];
	\draw[->, red] (0,2.5) -- (0,1.5) node[midway, right] {$F_2$};
	\draw[->, red] (0,0) -- (0,-1) node[midway, right] {$Mg$};
	\draw[->, red] (0,-2.2) -- (0,-1.2) node[midway, right] {$F_1$};
	\draw [decorate, decoration = {brace, amplitude=2mm}] (-0.55,-1.3) -- (-0.55,1.5) node[midway, left=2mm] {$\ell$};
	\fill (1.1,0.8) circle (1pt) node[above] {$P_2$};
	\fill (1.1,-1.2) circle (1pt) node[below] {$P_1$};
	%\fill (1.1,0.8) circle (0pt) node[above] {$P_2$};
	\draw[<->, dashed] (1.3,0.8) -- (1.3,-1.2) node[midway, right] {$F_1$};
	\node at (-2,-1) {$\rho_{f1}$};
	\node at (-0.2,1) {$\rho$};
	\node at (1.6,1.6) {$M\rho\ell A$};
	\draw (-0.8,1.9) -- (-0.3,1.5) node[at start, above] {$A$};
\end{tikzpicture}
}%
\end{figure}
...
\begin{tikzpicture}
  ...
  \path[draw=black]
	...
	\node at (-0.5,-0.1) {CM};
	\node at (-0.5,-0.5) {X};
	\draw[->, red] (-0.5,-0.5) -- (-0.5,-1.5) node[left] {$Mg$};

	\fill (0.2,-0.4) circle (1pt);
	\draw[->, red] (0.2,-0.4) -- (0.2,1.1) node[midway, right] {$F_b$};

	\draw[dashed] (-1.7,0.1) -- (1.8,0.1);
...
\begin{tikzpicture}
	\draw [short] (6.5,31.75) -- (6.5,31.75);
	\draw [short] (6,31.5) -- (8,31.5);
	\draw [short] (8,31.5) .. controls (8.75,31.5) and (8.5,31.5) .. (9,32);
	\draw [short] (9,32) .. controls (9.75,32.75) and (9.5,33.75) .. (10.25,33.75);
	\draw [short] (10.25,33.75) -- (13.25,33.75);
	\draw [short] (6,30.5) -- (9,30.5);
	\draw [short] (9,30.5) .. controls (9.75,30.5) and (9.5,30.5) .. (10,31.25);
	\draw [short] (10,31.25) .. controls (10.5,31.75) and (10.5,31.5) .. (11,31.75);
	\draw [short] (11,31.75) -- (13.25,31.75);
	\draw  (7,31) ellipse (0.25cm and 0.5cm);
	\draw  (12.75,32.75) ellipse (0.5cm and 1cm);
	\draw [->, >=Stealth, red] (7,31) -- (9,31) node[above] {$v_1$};
	\draw [->, >=Stealth, red] (12.75,32.75) -- (13.5,32.75) node[above] {$v_2$};
	\draw [->, >=Stealth] (5,32) -- (5,33.75) node[right] {$y$};
	\draw [dashed] (7,31) -- (5.25,31) node[left] {$y_1$};
	\draw [dashed] (12.75,32.75) -- (15,32.75) node[right] {$y_2$};
	\draw [short] (12.75,33.5) -- (13.5,34.5) node[above] {$P_1$};
	\draw [short] (7,31.5) -- (6.75,32.25) node[above] {$A_1$};
	\draw [short] (7,31.5) -- (7.5,32.25) node[above] {$A_2$};
\end{tikzpicture}
}%
\label{fig:my_label}
\end{figure}
...
\tikzstyle{every node}=[font=\LARGE]
	\draw [short] (6.5,31.75) -- (6.5,31.75);
	\draw [short] (5,33.25) -- (8.5,33.25);
	\draw [short] (5,33.25) -- (5,35.5);
	\draw [short] (8.5,33.25) -- (8.5,35.5);
	\draw [short] (5,35.25) -- (8.5,35.25) node[midway, above] {$P_2=1$};
	\draw [short] (5.25,34.5) -- (5.75,35);
	\draw [short] (5.25,34) -- (6.25,35);
	\draw [short] (5.25,33.5) -- (6.75,35);
	\draw [short] (6,33.75) -- (7,34.75);
	\draw [short] (7.5,34.75) -- (7.5,35.75);
	\draw [short] (8.25,34.75) -- (8.25,35.75);
	\draw [short] (9.5,35.75) -- (9.5,30.25);
	\draw [short] (10.25,35.75) -- (10.25,30.25);
	\draw [short] (8.25,35.75) .. controls (8.5,36.5) and (9.25,36.5) .. (9.5,35.75);
	\draw [short] (7.5,35.75) .. controls (8,37.5) and (9.75,37.5) .. (10.25,35.75);
	\draw [short] (6.75,33.75) -- (7.5,34.5);
	\draw [short] (9.75,31) -- (10,31.25);
	\draw [short] (9.75,31.75) -- (10,32);
	\draw [short] (9.75,32.5) -- (10,32.75);
	\draw [short] (9.75,33.25) -- (10,33.5);
	\draw [short] (9.75,34) -- (10,34.25);
	\draw [short] (9.75,34.75) -- (10,35);
	\draw [short] (9.75,35.5) -- (10,35.75);
	\draw [short] (7.5,33.75) -- (8,34.25);
	\draw [short] (7.75,35) -- (8,35.25);
	\draw [short] (7.75,35.5) -- (8,35.75);
	\draw [short] (8.5,36.5) -- (8.75,36.75);
	\draw [short] (9.25,36.5) -- (9.5,36.75);
	\draw [short] (9.5,36) -- (9.75,36.25);
	\draw [short] (8,36.25) -- (8.25,36.5);
	\draw [dashed] (8.5,35.25) -- (11.5,35.25);
	\draw [dashed] (9,37) -- (11.5,37);
	\draw [dashed] (5,35.25) -- (3.25,35.25);
	\draw [dashed] (3.25,35.25) -- (5.25,35.25) node[at start, left] {$y_2$};
	\draw [dashed] (10.5,30.25) -- (3.25,30.25) node[at start, right] {$P_1=1$} node[left] {$y_1$};
	\draw [<->, >=Stealth, dashed] (3.75,30.25) -- (3.75,35.25) node[midway, left] {$h$};
	\draw [->, >=Stealth] (1.5,32.25) -- (1.5,33.75) node[midway, left] {$y$};
	\draw [->, >=Stealth, red] (9.75,30.75) -- (9.75,29.5) node[at start, left] {$v_1$};
	\draw [->, >=Stealth, red] (5.25,35) -- (5.25,36) node[above] {$v_2=0$};
	\draw [<->, >=Stealth, dashed] (11.25,35.25) -- (11.25,37) node[midway, right] {d};
\end{tikzpicture}
}%
\end{figure}
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
\draw [short] (6,13.75) -- (6,18);
\draw [short] (6.5,13.75) -- (6.5,18);
\draw [short] (6,18) -- (4.25,20.5);
\draw [short] (6.5,18) -- (8.5,20.25);
\draw [short] (6.25,17.25) .. controls (6,18.75) and (5.5,18.75) .. (5.5,20.75);
\draw [short] (6.25,17.25) .. controls (6.5,18.5) and (6.75,18) .. (7.5,20.5);
\draw [short] (11.5,21.5) -- (11.25,16.75);
\draw [short] (12.25,21.5) -- (12.25,16.75);
\draw [short] (12.25,16.75) -- (13.75,14.75);
\draw [short] (9.25,14.75) -- (11.25,16.75);
\draw  (6.25,18.75) circle (0.5cm);
\draw  (11.75,16.5) circle (0.5cm);
\end{tikzpicture}
}%
\end{figure}
...
\begin{tikzpicture}
\tikzstyle{every node}=[font=\LARGE]
\draw [short] (8.5,15) .. controls (7.75,18.25) and (7.5,19.25) .. (6,21);
\draw [short] (9,15) .. controls (10,17.75) and (10.25,18.75) .. (11.75,21.25);
\draw  (9.25,18) circle (0.75cm);
\draw [->, >=Stealth] (8.5,15.5) -- (8.25,20.25);
\end{tikzpicture}
}%
\end{figure}
