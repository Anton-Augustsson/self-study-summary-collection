...
\begin{tikzpicture}[scale=1]
  ...
  to[out=0, in=120] (6,2);
	...
	\filldraw[black] (6,2) circle (2pt) node[right] {break!};

  	\draw[-{Stealth}] (1.8,1.9) -- (1.2,2.45) node[midway, below=4mm] {elastic limit};
  	\draw[-{Stealth}] (4,2) -- (3,2.8) node[midway, below=4mm] {plastic flow};
