...
\begin{tikzpicture}
  ...
  \fill (0.3,-0.5) circle (1pt) node[left] {$\ell$};
  \node[right] at (2.5,-0.2) {\Large$\tau = \ell\,\vec{F}$};

  \begin{scope}[shift={(-0.3,-0.9)}, rotate=60]
    \draw[<->, thick] (0,0.6) -- (0,-0.6);
    \draw[->, thick, red] (0,0.6) -- (-1,0.6) node[below left] {\large$\vec{F}$};
    \draw[->, thick, red] (1,-0.6) -- (2,-0.6) node[above right] {\large$\vec{F}$};
    \draw[dotted, red] (0,-0.6) -- (1,-0.6);
  \end{scope}
...
\begin{tikzpicture}
  ...
  \fill (0,2.5) circle (2pt) node[left] {$P$};
  \fill (4,0) circle (2pt) node[below] {$Q$};
  \fill (2,1.25) circle (2pt) node[above] {$C$};

  \draw[->, red] (0,2.5) -- (1.5,2.5) node[above right] {$N_P$};
  \draw[->, red] (2,1.25) -- (2,-0.5) node[right] {$Mg$};
  \draw[->, red] (4,0) -- (4,1.5) node[above right] {$N_Q$};
  \draw[->, red] (4,0) -- (3.3,0) node[below] {$F_f$};

  \draw (3,0) arc[start angle=200, end angle=120, radius=4mm];
  \node[left] at (2.9,0.4) {\large$\alpha$};
...
\begin{tikzpicture}
  ...
  \draw[->, red] (0,2.5) -- (1.5,2.5) node[above right] {$N_P$};
  \draw[->, red] (2,1.25) -- (2,-0.5) node[left] {$Mg$};
  \draw[->, red] (4,0) -- (4,1.5) node[above right] {$N_Q$};
  \draw[->, red] (4,0) -- (3.3,0) node[below] {$F_f$};
  ...
  \fill[red] (2.9,0.7) circle (2pt);
  \draw [decorate, decoration = {brace, amplitude=2mm}] (0,0) -- (0,2.5);
  \draw [decorate, decoration = {brace, amplitude=2mm}] (2.9,0.7) -- (4,0) node[midway, above=2mm] {$d$};
  \draw[->, red] (2.9,0.7) -- (2.9,-0.2) node[left] {$mg$};
\end{tikzpicture}
\end{figure}
...
\draw[red] (\ct-0.18,\st+0.3,-5) arc[start angle=0,delta angle=120,radius=1];
\draw[red] (\ct,\st,-3) arc[start angle=\ang,delta angle=180,radius=1];
\draw[red] (\ct,\st,-2) arc[start angle=\ang,delta angle=180,radius=1];
\end{scope}
\end{scope}

\draw[ultra thick, red] (2.265,-0.5) -- (2.265,1.38) node[black, midway, right] {$T_1=mg$};
\draw[ultra thick, red] (-0.2,-2.5) -- (-0.2,-0.9) node[black, midway, left] {$T_2=Mg$};

\draw[ultra thick] (-1.2,-4.0) rectangle (1.0,-2.5) node[midway] {$M$};
\draw[ultra thick] (1.5,-1.8) rectangle (3.0,-0.2) node[midway] {$m$};
...
\begin{tikzpicture}
  ...
  \draw[dotted] (0,0) -- (2,0);
  \draw[dotted] (0,0) -- (0,2);
  \draw (0.4,0) arc[start angle=0,delta angle=90,radius=0.4] node [midway, above] {$\theta_0$};

  \draw[ultra thick, red] (0,2.05) arc[start angle=90,end angle=0,radius=2.05];
  \draw[ultra thick, red] (0,2.05) -- (-3,2.05) node[black, below] {$T_2$};
  \draw[ultra thick, red] (2.05,0) -- (2.05,-3) node[black, above] {$T_1$};

  \draw[ultra thick, ->] (0.8,3) arc[start angle=70,end angle=100,radius=3.0] node[left] {slip};
  \end{scope}

  \begin{scope}[rotate=55]
    \draw (1.8,0) -- (2.2,0);
    \draw[thick, ->, red] (2.4,0) arc[start angle=0,end angle=-8,radius=2.4];
  \end{scope}
...
\begin{tikzpicture}
  ...
  % Pivot point P
  \fill[thick] (-0.6,-0.4) circle (2pt) node[black, above] {\Large$P$};

  % Center of mass
  \node at (0.5,-1.0) {x};
  \node at (0.9, -1.0) {CM};
  %\node at (0,5,-1.0) {\small\textbf{CM}};

  % Vector from P to CM (r_P)
  \draw[->, thick, red] (-0.6,-0.4) -- (0.5,-1.0) node[midway, above] {$\vec{r}_P$};

  % Gravity vector
  \draw[->, thick, red] (0.5,-1.0) -- (0.5,-2.5) node[below] {\small$mg$};

  % Dashed vertical from pivot
  \draw[dotted] (0.5,-1.0) -- (1.5,-1.8);

  \draw (0.5,-1.8) arc[start angle=-90,end angle=-20,radius=0.6];
...
\begin{tikzpicture}[scale=1]
  ...
  \draw (0,0) -- (0,4);
	\draw (0,0) -- (7,0) node[at start, below] {$0$} node[below=1mm] {$\rightarrow\Delta\ell/\ell$} node[midway, below] {strain};
  ...
  \draw[thick, smooth] 
  (0,0) 
  to[out=60, in=180] (1.5,2.5)
  to[out=-10, in=180] (4.5,3.2)
  to[out=0, in=120] (6,2);

	\filldraw[black] (6,2) circle (2pt) node[right] {break! (\textit{ultimate tensile strength})};

  	\draw[-{Stealth}] (1.8,1.9) -- (1.2,2.45) node[midway, below=4mm] {\textit{elastic limit}};
  	\draw[-{Stealth}] (4,2) -- (3,2.8) node[midway, below=4mm] {\textit{plastic flow}};
