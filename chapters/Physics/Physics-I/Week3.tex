...
\begin{tikzpicture}[scale=1]
  ...
  \draw[thick, red, -{Stealth[scale=1.5]}] (0.1,0) -- (0.1,2) node[right = 2mm] {$N=mg$};
  \draw[thick, red, -{Stealth[scale=1.5]}] (-0.1,0.5) -- (-0.1,-1.5) node[right = 2mm] {$mg$};
  \draw[thick, red, -{Stealth[scale=1.5]}] (0,0) -- (-1.5,0) node[below = 2mm] {$F_F$};
  \draw[thick, red, -{Stealth[scale=1.5]}] (-2.5,0.5) -- (-1,0.5) node[midway, above = 2mm] {$F_{WL}$};

  \draw[thick, -{Stealth[scale=1.5]}] (-4,2) -- (-2,2) node[above = 2mm] {$x$};
  \draw[thick, -{Stealth[scale=1.5]}] (-3,2) -- (-3,3) node[above = 2mm] {$y$};
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[thick, -{Stealth[scale=1.5]}] (1,1) -- (0,1) node[above = 2mm] {$x$} node[left] {$+$};
  \draw[thick, -{Stealth[scale=1.5]}] (1,1) -- (1,2) node[left = 1mm] {$y$};

  \draw[thick] (2.5,0) rectangle (4.5,1);

  \draw[thick, red, -{Stealth[scale=1.5]}] (3.6,0) -- (3.6,2) node[right=2mm] {$N=mg\cos{\alpha}$};
  \draw[thick, green, -{Stealth[scale=1.5]}] (3.5,0.5) -- (2,0.5) node[above=4mm] {$mg\sin{\alpha}$};
  \draw[thick, green, -{Stealth[scale=1.5]}] (3.5,0.5) -- (3.5,-2) node[right=2mm] {$mg\cos{\alpha}$};

  \draw[thick, red, -{Stealth[scale=1.5]}] (3.5,0.5) -- (2.4,-1.9) node[right=2mm] {$mg$};

  \end{scope}

  \draw[thick] (0,0) -- (2,0);
  \draw (1,0) arc (0:30:1) node[midway, right] {$\alpha$};
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[thick, -{Stealth[scale=1.5]}] (0,1) -- (1,1) node[above = 2mm] {$x$};
  \draw[thick, -{Stealth[scale=1.5]}] (0,1) -- (0,2) node[left = 1mm] {$y$};
  ...
  \draw[thick, red, -{Stealth[scale=1.5]}] (3.5,0.5) -- (2.4,-1.9) node[right=2mm] {$m_1g$};

  \draw[thick] (7,0.25) circle (2.5mm);
  \draw (4.5,0.5) -- (7,0.5);
  \draw (7.25,0.18) -- (6,-2);
  ...
  \draw[thick] (0,0) -- (2,0);
  \draw (1,0) arc (0:30:1) node[midway, right] {$\alpha$};
  \fill (6.19,1.2) circle (1mm) node[right] {$m_2$};
  \draw[thick, red, -{Stealth[scale=1.5]}] (6.19,1.2) -- (6.19,-0.5) node[right=2mm] {$m_2g$};
